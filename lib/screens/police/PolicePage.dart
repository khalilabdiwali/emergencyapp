...
class _HospitalChatState extends State<HospitalChat> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Hospital Department', style: GoogleFonts.nunito()),
      ),
      body: Padding(
                  ...
                  child: userList.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            bool isLastMessage = index == userList.length - 1;
                            return ListTile(
                              ...
                              trailing: Icon(
                                  isLastMessage ? Icons.check : Icons.chat,
                                  color: Colors.white),
                            );
                          },
                        ),
