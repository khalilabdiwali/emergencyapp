...
import 'package:sms/screens/hospital/HospitalsPage.dart';
...
enum UserRole { regular, medical }

class HospitalChat extends StatefulWidget {
  @override
  _HospitalChatState createState() => _HospitalChatState();
}

class _HospitalChatState extends State<HospitalChat> {
  ...
  Future<void> _getUser() async {
    ...
    if (user != null) {
      setState(() {
        userId = user.uid;
        userRole = user.email == "medical@example.com"
            ? UserRole.medical
            : UserRole.regular;
      });
    }
      ...
      if (snapshot.snapshot.value != null && snapshot.snapshot.value is Map) {
        ...
        setState(() {
          ...
          values.forEach((key, value) {
            ...
            if (value['role'] == 'medical' && userRole == UserRole.regular) {
              userList.add(userData);
            } else if (value['role'] == 'regular' &&
                userRole == UserRole.medical) {
              userList.add(userData);
            }
          });
        });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Medical Department', style: GoogleFonts.openSans()),
      ),
      body: Padding(
